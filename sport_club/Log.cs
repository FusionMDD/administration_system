...
namespace sport_club
{
    public partial class Log : Form
    {
        ...
        private void Log_Load(object sender, EventArgs e)
        {
            ...
            // TODO: данная строка кода позволяет загрузить данные в таблицу "sportDataSet.Log". При необходимости она может быть перемещена или удалена.
            this.logTableAdapter.Fill(this.sportDataSet.Log);

        }

        private void button1_Click(object sender, EventArgs e)
        {
            logTableAdapter.FillBy(sportDataSet.Log,comboBox1.Text);
        }

        private void button2_Click(object sender, EventArgs e)
        {
            logTableAdapter.FillBy1(sportDataSet.Log,dateTimePicker1.Value,dateTimePicker2.Value);
        ...
        {
            logTableAdapter.Fill(sportDataSet.Log);
        }
    }
}
