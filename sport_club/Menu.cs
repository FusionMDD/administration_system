...
namespace sport_club
{
    public partial class Menu : Form
    {
        ...
        private void Menu_Load(object sender, EventArgs e)
        {
            ...
            label1.Text = "Ви авторизовані як " + Login.log_login;
            label2.Text = "Ваш рівень доступу " + sign_inTableAdapter1.ScalarQuery1(Login.log_login);
        }
        ...
        {
            DialogResult result = MessageBox.Show("Бажаєте вийти?", "Вихід", MessageBoxButtons.YesNo, MessageBoxIcon.Question);
