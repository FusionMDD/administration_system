...
{
    public partial class add_training : Form
    {
        public add_training()
        {
            InitializeComponent();
        ...
        private void тренуванняToolStripMenuItem1_Click(object sender, EventArgs e)
        {
        ...
        private void add_training_Load(object sender, EventArgs e)
        {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            s = customer3TableAdapter.CustomerQuery(s);

            training2TableAdapter.Insert(Convert.ToString(id), trdateDateTimePicker.Value, descriptionTextBox.Text, s);
