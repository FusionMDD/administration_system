...
{
    public partial class Training_view : Form
    {
        ...
        private void training1BindingNavigatorSaveItem_Click(object sender, EventArgs e)
        {
            this.Validate();
        ...
        private void Training_view_Load(object sender, EventArgs e)
        {
            ...
            // TODO: данная строка кода позволяет загрузить данные в таблицу "sportDataSet.Training1". При необходимости она может быть перемещена или удалена.
