...
{
    public partial class Trainer_search : Form
    {
        ...
        private void Trainer_search_Load(object sender, EventArgs e)
        {
        ...
        {
            trainer1TableAdapter.FillBy3(sportDataSet.Trainer1,Convert.ToString(dateTimePicker1.Value), Convert.ToString(dateTimePicker2.Value));
        }
    }
}
