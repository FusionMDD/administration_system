...
{
    public partial class search_training : Form
    {
        public search_training()
        {
            InitializeComponent();
        }
        ...
        private void search_training_Load(object sender, EventArgs e)
        {
            ...
            // TODO: данная строка кода позволяет загрузить данные в таблицу "sportDataSet.DataTable2". При необходимости она может быть перемещена или удалена.
            this.dataTable2TableAdapter.Fill(this.sportDataSet.DataTable2);
        ...
        {
           dataTable2TableAdapter.FillBy1(sportDataSet.DataTable2, comboBox1.Text);
        }

        private void button2_Click(object sender, EventArgs e)
        {
            dataTable2TableAdapter.FillBy(sportDataSet.DataTable2, dateTimePicker1.Value.AddDays(-1), dateTimePicker1.Value);
        }

        private void button3_Click(object sender, EventArgs e)
        {
            dataTable2TableAdapter.Fill(sportDataSet.DataTable2);
        }
