...
namespace sport_club
{
    public partial class add_inventory : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            inventory1TableAdapter.Insert(Convert.ToString(id), invnameTextBox.Text, invdescriptionTextBox.Text, Convert.ToInt32(quantityTextBox.Text),
                qualityTextBox.Text);
            ...
            quantityTextBox.Text = "";
            qualityTextBox.Text = "";
            MessageBox.Show("Інвентар внесено");
        }
        ...
        private void новийКористувачToolStripMenuItem_Click_1(object sender, EventArgs e)
        {
            add_pass frm = new add_pass();
            frm.Show();
            Close();
